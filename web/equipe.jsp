<%-- 
    Document   : home
    Created on : 26/06/2018, 17:27:32
    Author     : Tiago
--%>
          ...
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="site-heading">
                <h3><table>
                    <tr>
                        <td>
                            <img src="img/tiago.jpg" widht="150px" height="150px"><br>
                            Tiago Assis
                        </td>
                        <td>
                            <img src="img/felipe.jpg" widht="150px" height="150px"><br>
                            Ivan Felipe
                        </td>
                        <td>
                            <img src="img/patrick.jpg" widht="150px" height="150px"><br>
                            Patrick Donnarumma
                        </td>
                    </tr>
                </table></h3>
